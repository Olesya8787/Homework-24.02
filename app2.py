...
expression = """
Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro laudantium nihil
...
"""
# Find all positions "ad"
position = expression.find("ad")
while position != -1:
     print(position)   
     position = expression.find("ad", position+1)   

# Slice "ad" from text
print(expression.split("ad"))

# Replace all "Lorem" on "Hey you"
expression = expression.replace("Lorem", "Hey you")
print(expression)
